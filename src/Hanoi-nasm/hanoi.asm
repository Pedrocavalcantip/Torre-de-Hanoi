...
escrita_numero_disco:
    ...
    mov ecx, buffer_numero_discos       ;carrega o endereço do buffer de entrada em ecx
    call escrita_caractere              ;chama a função escrita_caractere para exibir o caractere
    ret
...
verificar_entrada:
    ...
    ;caso de entrada invalida, exibe uma mensagem de erro e retorna para a execução principal.
    entrada_invalida:
    mov ecx, caso_erro                  ;carrega o endereço da string de erro em ecx
    call exibir_string                  ;chama a função exibir_string para exibir a mensagem
    mov ecx, LF                         ;carrega o endereço da quebra de linha em ecx
    call escrita_caractere              ;chama a função escrita_caractere para exibir a quebra de linha
    jmp execução_principal              ;retorna para a execução principal
...
exibir_string:
    ...
    loop_exibir:
        ...
        call escrita__de_caractere      ;chama a função escrita_de_caractere para exibir o caractere
